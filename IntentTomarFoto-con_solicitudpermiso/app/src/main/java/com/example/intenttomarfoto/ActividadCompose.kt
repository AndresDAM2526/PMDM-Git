...
fun TomarFoto(modificador: Modifier) {
    ...
    Column(
        ...
        Button(onClick = {
            /*
            let ejecuto lo mismo que se describe abajo
            if(actividad!=null){
                mostrar_mensaje=actividad.shouldShowRequestPermissionRationale
             */
            ...
            if (ContextCompat.checkSelfPermission(
                ...
                //Se esta registrando la imagen , se le indica el nombre, el tipo de fichero y la ruta
            ...
            } else if (mostrar_mensajepermiso) { // Ya he solicitado el permiso en algún momento y dije que no
                mostrar_dialogo = true
            } else {
                Log.i("INFO", "Se mete por el else")
                // Solicitar permiso si no lo tengo concedido,Para lanzar la actividad se le tiene que pasar un String, que Manifest.permission.CAMERA lo es
