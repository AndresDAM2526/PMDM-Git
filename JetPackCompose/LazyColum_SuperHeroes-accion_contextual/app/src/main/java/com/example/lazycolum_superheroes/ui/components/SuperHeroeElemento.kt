...
fun ElementoLazySuperHeroe(misuperheroe: SuperHeroe, modificador: Modifier= Modifier, selecionado:()->Boolean, click_borrar:()->Unit, click_largo:()->Unit, click_corto:()->Unit)
{
    ...
    Card(modifier = modificador
        .combinedClickable(onLongClick =  click_largo , onClick =  click_corto )
        ...
        Row (modifier = Modifier
            .fillMaxWidth()
            .background(color_fondo), verticalAlignment = Alignment.CenterVertically){

            GlideImage(misuperheroe.foto, modifier = Modifier
                .size(DpSize(150.dp, 150.dp))
                .padding(start = 4.dp), contentDescription = "")
